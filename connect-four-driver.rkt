...
;;; Racket.
;;;(define exe-1 "/Applications/Racket v6.8/bin/racket")
;;;(define args-1 "connect-four-naive.rkt")
;;;(define exe-2 "/Applications/Racket v6.8/bin/racket")
;;;(define args-2 "connect-four-naive.rkt")
;;;(define exe-1 "/usr/bin/python")
;;;(define args-1 "connectfour.py")
(define exe-1 "/bin/bash")
(define args-1 "main.sh")
(define exe-2 "/bin/bash")
(define args-2 "main.sh")
